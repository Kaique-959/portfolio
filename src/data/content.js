  ...
  services: [
    {
      ...
      description: 'Agentes conversacionais para atendimento, qualificação, triagem e execução de tarefas em canais digitais.',
      tags: ['IA', 'WhatsApp', 'Telegram', 'Automação'],
    },
    {
      title: 'Automação de Processos',
      description: 'Mapeamento de gargalos e workflows que conectam pessoas, sistemas e dados para eliminar retrabalho.',
      tags: ['N8N', 'APIs', 'Workflows'],
    },
    {
      title: 'Mensageria Multicanal',
      description: 'Operações de follow-up e comunicação por WhatsApp, e-mail, SMS e voz com histórico rastreável.',
      tags: ['WhatsApp', 'E-mail', 'SMS', 'Voz'],
    },
    {
      title: 'CRM & Atendimento',
      description: 'CRMs e centrais de atendimento que unificam contatos, conversas, agenda, tarefas e histórico da operação.',
      tags: ['CRM', 'Chatwoot', 'Supabase'],
    },
    {
      title: 'SaaS Sob Medida',
      description: 'Produtos web completos, do micro sistema ao SaaS, com autenticação, banco, painéis e evolução por etapas.',
      tags: ['React', 'Next.js', 'Supabase'],
    },
    {
      title: 'Microsserviços & Integrações',
      description: 'Integrações entre ERP, CRM, WhatsApp, planilhas e APIs para fazer sistemas isolados trabalharem juntos.',
      tags: ['REST', 'Webhooks', 'APIs'],
    },
    {
      title: 'Sites, Portais & Plataformas',
      description: 'Presença digital, portais institucionais e plataformas com conversão, SEO e integração com a operação.',
      tags: ['React', 'SEO', 'Acessibilidade'],
    },
    {
      title: 'Dashboards & Dados',
      description: 'Informações dispersas viram painéis claros, métricas acionáveis, funis e alertas para decisão rápida.',
      tags: ['Dashboards', 'Big Data', 'Métricas'],
    },
    {
      title: 'Pagamentos & PIX',
      description: 'Fluxos de cobrança, QR Code, copia e cola e mensagens prontas para simplificar pagamentos pelo WhatsApp.',
      tags: ['PIX', 'BR Code', 'Cobrança'],
    },
    {
      title: 'ITSM & Monitoramento',
      description: 'Service desk, SLA, inventário e alertas para organizar ativos tecnológicos e rotinas de suporte.',
      tags: ['GLPI', 'ITSM', 'SLA'],
    },
    {
      title: 'Infraestrutura & Segurança',
      description: 'Deploy, domínios, redes privadas e acessos remotos com uma base segura para a operação crescer.',
      tags: ['VPN', 'DNS', 'Deploy'],
    },
    {
      title: 'Conteúdo Automatizado',
      description: 'Geração e publicação de carrosséis, posts e vídeos para redes sociais com autonomia e calendário.',
      tags: ['Instagram', 'LinkedIn', 'TikTok'],
    },
    {
      title: 'Dados, Telemetria & Geomarketing',
      description: 'Camadas de dados públicos, localização e telemetria para encontrar padrões e orientar ações.',
      tags: ['Python', 'Dados', 'Mapas'],
    },
    {
      title: 'Arquitetura & Consultoria',
      description: 'Diagnóstico técnico, desenho de solução e priorização para investir primeiro no gargalo que traz resultado.',
      tags: ['Arquitetura', 'Estratégia', 'Produto'],
    },
    {
      title: 'Edição & Motion',
      description: 'Vídeos para empresas, anúncios e redes sociais com montagem dinâmica e identidade visual consistente.',
